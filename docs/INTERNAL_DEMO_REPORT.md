...
Generated: `2026-05-02T17:51:42+00:00`
...
| Test status | `118 passed in 15.97s` |
...
4. Regenerate this report: `rtk uv run chatter-twin internal-demo-report --out docs/INTERNAL_DEMO_REPORT.md --summary-out docs/INTERNAL_DEMO_SUMMARY.json --test-status "118 passed in 15.97s"`.
